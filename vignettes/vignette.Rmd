...
The `NAs` correspond to the unfinished $\lambda$ values. We don't have to compute the entire solution path if a validation set is provided and an optimal solution has been found.
